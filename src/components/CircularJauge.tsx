...
const CircularGauge = ({
  ...
  const segments = Array.from({ length: totalSegments }, (_, index) => {
    ...
    const color = index < filledSegments ? interpolateColor(ratio) : "#656565";
    const borderColor = index < filledSegments ? darkenColor(color) : "#4f4f4f";

    const segmentHeight =
      index === 0 || index === totalSegments - 1 || index % 5 === 0 ? 15 : 10;
    const yPosition =
      ...
      <div className="gauge-score">
        ...
        <div className="score-info">
          <div className="text-center">
            ...
            {score >= 71 && score < 81 && <span>Very Impressive!</span>}
            {score >= 81 && score < 91 && <span>Outstanding!!</span>}
            {score >= 91 && score < 100 && (
